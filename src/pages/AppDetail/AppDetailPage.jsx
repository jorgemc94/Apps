...
export function AppDetail() {
  ...
  return (
    <PageTransition variants={pageVariants} initial="initial" animate="animate" exit="exit" transition={pageTransition}>
      <PageWrapper>
        ...
        {!isDesktop && (
          <ProgressBarWrapper>
            <ProgressBar as={motion.div} animate={{ width: `${progress}%` }} transition={{ duration: 0.3 }} />
          </ProgressBarWrapper>
        )}
      </PageWrapper>
    </PageTransition>
